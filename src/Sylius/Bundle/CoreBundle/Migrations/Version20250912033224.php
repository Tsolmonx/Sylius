 ...
 */
final class Version20250912033224 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sylius_order_item CHANGE unit_price unit_price BIGINT NOT NULL, CHANGE original_unit_price original_unit_price BIGINT DEFAULT NULL, CHANGE units_total units_total BIGINT NOT NULL, CHANGE adjustments_total adjustments_total BIGINT NOT NULL, CHANGE total total BIGINT NOT NULL');
